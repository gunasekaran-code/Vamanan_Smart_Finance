...
class WithdrawalReportsScreen extends StatefulWidget {
  const WithdrawalReportsScreen({super.key});

  @override
  State<WithdrawalReportsScreen> createState() => _WithdrawalReportsScreenState();
}

class _WithdrawalReportsScreenState extends State<WithdrawalReportsScreen> {
  ...
  void _handleRefreshProtocol() {
    ToastService.show(
      ...
      message: 'Withdrawal intelligence data synced with the global node.',
  ...
  Future<void> _handleExportLedger() async {
    final confirmed = await AppConfirmDialog.show(
      context: context,
      title: 'EXPORT LEDGER',
      message: 'Generate a full data dump of the withdrawal registry?',
      confirmLabel: 'EXPORT',
      cancelLabel: 'CANCEL',
    ...
    if (confirmed == true) {
      ToastService.show(
        ...
        message: 'The withdrawal ledger is being prepared for download.',
        type: ToastType.success,
      );
    }
  }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // --- 6. Liquidity Outflow Matrix ---
              _buildLiquidityOutflowMatrix(),
              const SizedBox(height: 24),
  ...
  Widget _buildLiquidityOutflowMatrix() {
    return Container(
      padding: const EdgeInsets.all(32),
      decoration: BoxDecoration(
        color: Colors.white,
          ...
          Row(
            ...
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('LIQUIDITY OUTFLOW MATRIX', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w900, fontStyle: FontStyle.italic, color: Color(0xFF1E3A8A))),
                  const SizedBox(height: 4),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
                ...
                Widget titleArea = Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.account_balance, color: Color(0xFF3B82F6), size: 24), // Bank icon from image_e9249f.png
                    ),
          ...
          // Scrollable Table Header (matches image_e9249f.png)
